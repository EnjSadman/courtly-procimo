...
export function Hero() {
  return (
    <section className="relative isolate flex h-full flex-1 items-center justify-center overflow-hidden">
      ...
      <div className="flex max-w-xl flex-col items-center gap-4 px-5 py-10 text-center sm:px-8">
        ...
        <p className="max-w-md animate-fade-up-late text-base leading-relaxed text-muted">
